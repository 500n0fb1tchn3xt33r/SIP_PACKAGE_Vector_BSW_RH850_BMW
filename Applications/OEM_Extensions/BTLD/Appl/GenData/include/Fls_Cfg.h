...
/*
 * INPUT FILE:    D:\TEMP\DaVinci\Cfg-3931012\Generation\Cfg_Gen-1512723940593-0\AutosarFiles_ValGen-1512724983141-0\ExtGen_DrvFls_ECUC_3080042524000726212.arxml
 ...
 * GENERATED ON:   8 Dec 2017 - 10:23:08
 */
#ifndef FLS_CFG_H
#define FLS_CFG_H
...
#define FLS_E_COMPARE_FAILED              \
  DemConf_DemEventParameter_AutoCreatedDemEvent_FlsConfigSet_FLS_E_COMPARE_FAILED

/* Report error to DEM that erase job failed */
#define FLS_E_ERASE_FAILED                \
  DemConf_DemEventParameter_AutoCreatedDemEvent_FlsConfigSet_FLS_E_ERASE_FAILED

/* Report error to DEM that read job failed */
#define FLS_E_READ_FAILED                 \
  DemConf_DemEventParameter_AutoCreatedDemEvent_FlsConfigSet_FLS_E_READ_FAILED

/* Report error to DEM that write job failed */
#define FLS_E_WRITE_FAILED                \
  DemConf_DemEventParameter_AutoCreatedDemEvent_FlsConfigSet_FLS_E_WRITE_FAILED

/* Report error to DEM that read job failed due to double bit ECC error */
#define FLS_E_READ_FAILED_DED             \
  DemConf_DemEventParameter_DemEventParameter_007
