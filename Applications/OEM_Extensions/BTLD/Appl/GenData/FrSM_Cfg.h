...
#define FRSM_USE_DUMMY_STATEMENT STD_ON /* /MICROSAR/EcuC/EcucGeneral/DummyStatement */
#endif
#ifndef FRSM_DUMMY_STATEMENT
#define FRSM_DUMMY_STATEMENT(v) (v)=(v) /* PRQA S 3453 */ /* MD_MSR_19.7 */  /* /MICROSAR/EcuC/EcucGeneral/DummyStatementKind */
#endif
#ifndef FRSM_DUMMY_STATEMENT_CONST
#define FRSM_DUMMY_STATEMENT_CONST(v) (void)(v) /* PRQA S 3453 */ /* MD_MSR_19.7 */  /* /MICROSAR/EcuC/EcucGeneral/DummyStatementKind */
#endif
#ifndef FRSM_ATOMIC_BIT_ACCESS_IN_BITFIELD
#define FRSM_ATOMIC_BIT_ACCESS_IN_BITFIELD STD_ON /* /MICROSAR/EcuC/EcucGeneral/AtomicBitAccessInBitfield */
#endif
...
#define FRSM_WAKEUP_ECU_ALL_CLUSTERS          TRUE
...
/** 
  ...
  \{
*/ 
#define FrSM_IsColdstartEcuOfClusterConfig(Index)                     ((FrSM_GetClusterConfigOfPCConfig()[(Index)].ColdstartEcuOfClusterConfig) != FALSE)
#define FrSM_GetControllerIndexOfClusterConfig(Index)                 (FrSM_GetClusterConfigOfPCConfig()[(Index)].ControllerIndexOfClusterConfig)
#define FrSM_GetDemEventClusterStartupOfClusterConfig(Index)          (FrSM_GetClusterConfigOfPCConfig()[(Index)].DemEventClusterStartupOfClusterConfig)
#define FrSM_GetDemEventClusterSyncLossOfClusterConfig(Index)         (FrSM_GetClusterConfigOfPCConfig()[(Index)].DemEventClusterSyncLossOfClusterConfig)
...
#define FrSM_IsStartup_Cluster_Prod_Error_DetectOfClusterConfig(Index) ((FrSM_GetClusterConfigOfPCConfig()[(Index)].Startup_Cluster_Prod_Error_DetectOfClusterConfig) != FALSE)
#define FrSM_IsSync_Loss_Cluster_Prod_Error_DetectOfClusterConfig(Index) ((FrSM_GetClusterConfigOfPCConfig()[(Index)].Sync_Loss_Cluster_Prod_Error_DetectOfClusterConfig) != FALSE)
#define FrSM_GetTrcvStbyDelayOfClusterConfig(Index)                   (FrSM_GetClusterConfigOfPCConfig()[(Index)].TrcvStbyDelayOfClusterConfig)
#define FrSM_IsWakeupEcuOfClusterConfig(Index)                        ((FrSM_GetClusterConfigOfPCConfig()[(Index)].WakeupEcuOfClusterConfig) != FALSE)
...
#define FrSM_HasColdstartEcuOfClusterConfig()                         (TRUE != FALSE)
#define FrSM_HasControllerIndexOfClusterConfig()                      (TRUE != FALSE)
#define FrSM_HasDemEventClusterStartupOfClusterConfig()               (TRUE != FALSE)
#define FrSM_HasDemEventClusterSyncLossOfClusterConfig()              (TRUE != FALSE)
...
#define FrSM_HasStartup_Cluster_Prod_Error_DetectOfClusterConfig()    (TRUE != FALSE)
#define FrSM_HasSync_Loss_Cluster_Prod_Error_DetectOfClusterConfig()  (TRUE != FALSE)
#define FrSM_HasTrcvStbyDelayOfClusterConfig()                        (TRUE != FALSE)
#define FrSM_HasWakeupEcuOfClusterConfig()                            (TRUE != FALSE)
...
#define FRSM_COLDSTARTECUOFCLUSTERCONFIG                              STD_ON
...
#define FRSM_DEMEVENTCLUSTERSTARTUPOFCLUSTERCONFIG                    STD_ON
#define FRSM_DEMEVENTCLUSTERSYNCLOSSOFCLUSTERCONFIG                   STD_ON
...
#define FRSM_STARTUP_CLUSTER_PROD_ERROR_DETECTOFCLUSTERCONFIG         STD_ON
#define FRSM_SYNC_LOSS_CLUSTER_PROD_ERROR_DETECTOFCLUSTERCONFIG       STD_ON
...
#define FRSM_TRCV_HANDLINGOFCLUSTERCONFIG                             STD_OFF  /**< Deactivateable: 'FrSM_ClusterConfig.Trcv_Handling' Reason: 'the value of FrSM_Trcv_HandlingOfClusterConfig is always 'false' due to this, the array is deactivated.' */
...
#define FRSM_WAKEUPECUOFCLUSTERCONFIG                                 STD_ON
...
/** 
  ...
  \{
*/ 
#define FRSM_ISDEF_COLDSTARTECUOFCLUSTERCONFIG                        STD_OFF
#define FRSM_ISDEF_CONTROLLERINDEXOFCLUSTERCONFIG                     STD_OFF
#define FRSM_ISDEF_DEMEVENTCLUSTERSTARTUPOFCLUSTERCONFIG              STD_OFF
#define FRSM_ISDEF_DEMEVENTCLUSTERSYNCLOSSOFCLUSTERCONFIG             STD_OFF
...
#define FRSM_ISDEF_STARTUP_CLUSTER_PROD_ERROR_DETECTOFCLUSTERCONFIG   STD_OFF
#define FRSM_ISDEF_SYNC_LOSS_CLUSTER_PROD_ERROR_DETECTOFCLUSTERCONFIG STD_OFF
#define FRSM_ISDEF_TRCVSTBYDELAYOFCLUSTERCONFIG                       STD_OFF
#define FRSM_ISDEF_WAKEUPECUOFCLUSTERCONFIG                           STD_OFF
...
/** 
  ...
  \{
*/ 
#define FRSM_EQ2_COLDSTARTECUOFCLUSTERCONFIG                          
#define FRSM_EQ2_CONTROLLERINDEXOFCLUSTERCONFIG                       
#define FRSM_EQ2_DEMEVENTCLUSTERSTARTUPOFCLUSTERCONFIG                
#define FRSM_EQ2_DEMEVENTCLUSTERSYNCLOSSOFCLUSTERCONFIG               
...
#define FRSM_EQ2_STARTUP_CLUSTER_PROD_ERROR_DETECTOFCLUSTERCONFIG     
#define FRSM_EQ2_SYNC_LOSS_CLUSTER_PROD_ERROR_DETECTOFCLUSTERCONFIG   
#define FRSM_EQ2_TRCVSTBYDELAYOFCLUSTERCONFIG                         
#define FRSM_EQ2_WAKEUPECUOFCLUSTERCONFIG                             
...
/** 
  ...
  \{
*/ 
/**   \brief  value based type definition for FrSM_ColdstartEcuOfClusterConfig */
typedef boolean FrSM_ColdstartEcuOfClusterConfigType;
...
/**   \brief  value based type definition for FrSM_Startup_Cluster_Prod_Error_DetectOfClusterConfig */
typedef boolean FrSM_Startup_Cluster_Prod_Error_DetectOfClusterConfigType;

/**   \brief  value based type definition for FrSM_Sync_Loss_Cluster_Prod_Error_DetectOfClusterConfig */
typedef boolean FrSM_Sync_Loss_Cluster_Prod_Error_DetectOfClusterConfigType;
...
/**   \brief  value based type definition for FrSM_WakeupEcuOfClusterConfig */
typedef boolean FrSM_WakeupEcuOfClusterConfigType;
...
typedef struct sFrSM_ClusterConfigType
{
  ...
  FrSM_ColdstartEcuOfClusterConfigType ColdstartEcuOfClusterConfig;
  FrSM_Startup_Cluster_Prod_Error_DetectOfClusterConfigType Startup_Cluster_Prod_Error_DetectOfClusterConfig;
  FrSM_Sync_Loss_Cluster_Prod_Error_DetectOfClusterConfigType Sync_Loss_Cluster_Prod_Error_DetectOfClusterConfig;
  FrSM_WakeupEcuOfClusterConfigType WakeupEcuOfClusterConfig;
  ...
  Dem_EventIdType DemEventClusterStartupOfClusterConfig;
  Dem_EventIdType DemEventClusterSyncLossOfClusterConfig;
...
extern FUNC(void, FRSM_CODE) FrSM_Dem_ReportErrorEvent( Dem_EventIdType FrSM_EventId, Dem_EventStatusType FrSM_Status );
