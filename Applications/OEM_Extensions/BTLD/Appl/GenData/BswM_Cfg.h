...
/* -----------------------------------------------------------------------------
    &&&~ RULE DEFINES
 ----------------------------------------------------------------------------- */
#define BswMConf_BswMRule_BswMRule_DcmProgGlue_ResetWhenBtldDefaultSession (0) 
#define BswMConf_BswMRule_Rule_DcmEcuReset (1) 
...
{
  BswM_ActionListQueueType AL_AL_DcmProgGlue_ResetWhenBtldDefaultSession_True[1];
  BswM_ActionListQueueType AL_INIT_AL_Initialize[1];
  BswM_ActionListQueueType AL_AL_ResetExecution[1];
  BswM_ActionListQueueType AL_AL_switch_to_FULL_COM[1];
  BswM_ActionListQueueType AL_EcumAlOnRunII[1];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  BswM_ActionListQueueType raw[5];
...
extern FUNC(void, BSWM_CODE) ProgGlue_DcmDiagnosticSessionControl_Callout(void);
