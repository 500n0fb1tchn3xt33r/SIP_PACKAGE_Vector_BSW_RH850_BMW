 ...
 * Mode Interfaces:
 * ================
 *   Std_ReturnType Rte_Switch_DcmCommunicationControl_ComMConf_ComMChannel_A_FlexRay_5b5a9ac2_DcmCommunicationControl_ComMConf_ComMChannel_A_FlexRay_5b5a9ac2(Dcm_CommunicationModeType mode)
 ...
 *********************************************************************************************************************/
  ...
  **********************************************************/

  {
    ...
    Dcm_FctPtr = (FncPtrType)Rte_Switch_DcmCommunicationControl_ComMConf_ComMChannel_A_FlexRay_5b5a9ac2_DcmCommunicationControl_ComMConf_ComMChannel_A_FlexRay_5b5a9ac2; /* PRQA S 0313 */ /* MD_Rte_TestCode */
  }
  fct_status = TSC_Dcm_Rte_Switch_DcmCommunicationControl_ComMConf_ComMChannel_A_FlexRay_5b5a9ac2_DcmCommunicationControl_ComMConf_ComMChannel_A_FlexRay_5b5a9ac2(RTE_MODE_DcmCommunicationControl_DCM_ENABLE_RX_TX_NORM);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
static void Dcm_TestDefines(void)
{
  ...
  Dcm_SecLevelType Test_Dcm_SecLevelType_V_2 = DCM_SEC_LEV_L9;
