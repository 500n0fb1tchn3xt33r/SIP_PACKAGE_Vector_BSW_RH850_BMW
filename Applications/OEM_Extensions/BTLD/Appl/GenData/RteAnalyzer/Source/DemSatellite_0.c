 ...
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_DemEventParameter_007>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_DemEventParameter_008>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_DemEventParameter_009>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_DemEventParameter_010>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_DemEventParameter_011>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 ...
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_DemEventParameter_007>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_DemEventParameter_008>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_DemEventParameter_009>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_DemEventParameter_010>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_DemEventParameter_011>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 ...
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_DemEventParameter_007>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_DemEventParameter_008>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_DemEventParameter_009>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_DemEventParameter_010>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_DemEventParameter_011>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
