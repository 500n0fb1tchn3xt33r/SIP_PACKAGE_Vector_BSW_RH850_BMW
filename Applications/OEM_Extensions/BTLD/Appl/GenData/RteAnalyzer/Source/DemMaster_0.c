 ...
 *   - triggered by server invocation for OperationPrototype <ClearDTC> of PortPrototype <ClearDTC_DemClient_BTLD>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 ...
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <GetEventMemoryOverflow> of PortPrototype <OverflowIndPrimaryMemory_DemClient_BTLD>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 ...
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <GetNumberOfEventMemoryEntries> of PortPrototype <OverflowIndPrimaryMemory_DemClient_BTLD>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 ...
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <SelectDTC> of PortPrototype <ClearDTC_DemClient_BTLD>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
