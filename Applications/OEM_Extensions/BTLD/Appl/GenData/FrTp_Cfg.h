...
#define FRTP_USE_DUMMY_STATEMENT STD_ON /* /MICROSAR/EcuC/EcucGeneral/DummyStatement */
#endif
...
#define FRTP_ATOMIC_BIT_ACCESS_IN_BITFIELD STD_ON /* /MICROSAR/EcuC/EcucGeneral/AtomicBitAccessInBitfield */
#endif
...
#define FRTP_INVALID_SNV 0xFFFFU /*    */ 
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define FrTpConf_FrTpRxPdu_RxPduPool_TL_BRC_FR_32_Tp                  0
#define FrTpConf_FrTpRxPdu_RxPduPool_TL_MST_GW_TRNSM_FR_254_00980001_Tp 1
/**\} */
