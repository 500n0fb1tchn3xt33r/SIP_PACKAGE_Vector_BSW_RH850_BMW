...
*
*  GENERATION TIME : 2018-01-29 10:57:39.505723
*
------------------------------------------------------------------------------*/
 ...
 */
#define IntegrationSample_SWITCH_DEM_KILOMETER   STD_OFF
 ...
 */
#define IntegrationSample_SWITCH_DCMNOTIFICATION  STD_OFF

/**
 * \brief Switch IntegrationSampleSwitchGlobalEcuRunState
 */
#define IntegrationSample_SWITCH_EcuRunState  STD_OFF

/**
 * \brief Switch IntegrationSampleSwitchProvideTestStampDefaults
 */
#define IntegrationSample_SWITCH_ProvideTestStampDefaults  STD_OFF

/**
 * \brief Switch IntegrationSampleSwitchProvide_ST_CON_VEH
 */
#define IntegrationSampleSwitchProvide_ST_CON_VEH  STD_OFF
 ...
 */
#define IntegrationSample_EnableSplitVehicleStatus  STD_OFF
