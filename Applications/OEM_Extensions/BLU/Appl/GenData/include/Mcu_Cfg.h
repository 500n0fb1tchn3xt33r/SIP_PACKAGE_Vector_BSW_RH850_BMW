...
#define MCU_SW_STARTUP_TEST                 STD_ON

/* Pre-compile option for Ecm Reset StartUp Diagnostic Test */
#define MCU_ECM_STARTUP_TEST                STD_ON
...
#define MCU_USE_WRITE_VERIFY_ERROR_INTERFACE STD_OFF
...
#define TOTAL_CLMA_CONFIGURED               (uint8)0x00
...
#define MCU_E_CLOCK_FAILURE                 \
  DemConf_DemEventParameter_DemEventParameter_McuConfigSet_MCU_E_CLOCK_FAILED

/* The failure of writing to write-protected register is reported to DEM */
#define MCU_E_WRITE_TIMEOUT_FAILURE         \
  DemConf_DemEventParameter_DemEventParameter_McuConfigSet_MCU_E_WRITE_TIMEOUT_FAILURE

/* The failure of Reset startup Diagnostic operation is reported to DEM*/
#define MCU_E_RESETCONTROLLER_STARTUP_FAILURE \
  DemConf_DemEventParameter_DemEventParameter_McuConfigSet_MCU_E_RESETCONTROLLER_STARTUP_FAILURE
