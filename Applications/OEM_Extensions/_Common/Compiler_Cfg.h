...
#if defined (BLU) || defined (BM) || defined (FLASHDRIVER)
#else
#include "Rte_Compiler_Cfg.h"
#include "BAC4_3_Compiler_Cfg.h"
...
/*Defines used by startup code */
 /**********************************************************************************************************************
 *  Applicaion
 *********************************************************************************************************************/
//#define BRS_INT_INTBP 0x00000200
//#define BRS_INT_EBASE 0x00000000
//#define BRS_INT_TABLE_SECTION .intvect_ROM0

 /**********************************************************************************************************************
 *  BOOTMANAGER START 
 *********************************************************************************************************************/

//#define BmSample_CODE

//#define BM_INT_INTBP 0x00000200
//#define BM_INT_EBASE 0x00000000
...
**********************************************************************************************************************/
#if defined (BRS_DERIVATIVE_GROUP_F1L)   || \
    defined (BRS_DERIVATIVE_GROUP_F1H)   || \
    defined (BRS_DERIVATIVE_GROUP_F1M)   || \
    defined (BRS_DERIVATIVE_GROUP_F1K)   || \
    defined (BRS_DERIVATIVE_GROUP_P1M)   || \
    defined (BRS_DERIVATIVE_GROUP_P1H)   || \
    defined (BRS_DERIVATIVE_GROUP_R1M)   || \
    defined (BRS_DERIVATIVE_GROUP_D1M)   || \
    defined (BRS_DERIVATIVE_GROUP_D1L)   || \
    defined (BRS_DERIVATIVE_GROUP_E1L)   || \
    defined (BRS_DERIVATIVE_GROUP_E1M)   || \
    defined (BRS_DERIVATIVE_GROUP_E1FCC) || \
    defined (BRS_DERIVATIVE_GROUP_C1H)   || \
    defined (BRS_DERIVATIVE_GROUP_C1M)

    #define BRS_INT_INTBP 0x00000200
    #define BRS_INT_EBASE 0x00000000
    #define BRS_INT_TABLE_SECTION .intvect_ROM0
#else
  #error "DERIVATIVE Group not yet supported"
#endif
/**********************************************************************************************************************
