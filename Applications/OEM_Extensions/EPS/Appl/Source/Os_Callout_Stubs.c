 ...
 *********************************************************************************************************************/
	volatile OSServiceIdType ServiceId;
	volatile StatusType StatusType;
	volatile Os_ErrorInformationType Os_ErrorInformation;

	ServiceId = OSErrorGetServiceId();
	StatusType = Os_GetDetailedError((Os_ErrorInformationRefType)&Os_ErrorInformation);
