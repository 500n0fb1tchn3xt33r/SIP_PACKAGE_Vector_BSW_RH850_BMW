...
*
*  GENERATION TIME : 2018-01-22 11:14:56.305740
*
------------------------------------------------------------------------------*/
...
extern Std_ReturnType Dlog_ConditionCheckSvkBackup01
                      (
                         Dcm_OpStatusType OpStatus,
                         Dcm_NegativeResponseCodeType* ErrorCode
                      );

extern Std_ReturnType Dlog_ReadDataByIdentifierSvkBackup01
                      (
                         Dcm_OpStatusType OpStatus,
                         uint8* Data
                      );
extern Std_ReturnType Dlog_ConditionCheckSvkBackup02
                      (
                         Dcm_OpStatusType OpStatus,
                         Dcm_NegativeResponseCodeType* ErrorCode
                      );

extern Std_ReturnType Dlog_ReadDataByIdentifierSvkBackup02
                      (
                         Dcm_OpStatusType OpStatus,
                         uint8* Data
                      );
extern Std_ReturnType Dlog_ConditionCheckSvkBackup03
                      (
                         Dcm_OpStatusType OpStatus,
                         Dcm_NegativeResponseCodeType* ErrorCode
                      );

extern Std_ReturnType Dlog_ReadDataByIdentifierSvkBackup03
                      (
                         Dcm_OpStatusType OpStatus,
                         uint8* Data
                      );
