...
#  define Rte_Call_DemWrapper_ClearDTC_SelectDTC(arg1, arg2, arg3) (Dem_SelectDTC((uint8)0, arg1, arg2, arg3)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_DemWrapper_EvtInfo_DM_TEST_APPL_GetDTCOfEvent(arg1, arg2) (Dem_GetDTCOfEvent((Dem_EventIdType)26, arg1, arg2)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_DemWrapper_EvtInfo_DM_TEST_COM_GetDTCOfEvent(arg1, arg2) (Dem_GetDTCOfEvent((Dem_EventIdType)27, arg1, arg2)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_DemWrapper_GeneralDiagnosticInfo_GetDTCOfEvent Dem_GetDTCOfEvent
#  define RTE_START_SEC_DEMMASTER_0_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
#  ifdef RTE_PTR2ARRAYBASETYPE_PASSING
FUNC(Std_ReturnType, RTE_DEMMASTER_0_APPL_CODE) Dem_GetEventFreezeFrameDataEx(Dem_EventIdType EventId, uint8 RecordNumber, uint16 DataId, P2VAR(uint8, AUTOMATIC, RTE_DEMMASTER_0_APPL_VAR) DestBuffer, P2VAR(uint16, AUTOMATIC, RTE_DEMMASTER_0_APPL_VAR) BufSize); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  else
FUNC(Std_ReturnType, RTE_DEMMASTER_0_APPL_CODE) Dem_GetEventFreezeFrameDataEx(Dem_EventIdType EventId, uint8 RecordNumber, uint16 DataId, P2VAR(Dem_MaxDataValueType, AUTOMATIC, RTE_DEMMASTER_0_APPL_VAR) DestBuffer, P2VAR(uint16, AUTOMATIC, RTE_DEMMASTER_0_APPL_VAR) BufSize); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  endif
#  define RTE_STOP_SEC_DEMMASTER_0_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
