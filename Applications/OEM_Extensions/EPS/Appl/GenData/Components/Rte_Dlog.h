...
#  define Rte_IRead_Dlog_ModeSwitchRequestLifeCycle_LifeCycleRequest_requestMode() \
  (Rte_Default_RTE_Mode_switch_Task.Rte_RB.Rte_Dlog_Dlog_ModeSwitchRequestLifeCycle.Rte_LifeCycleRequest_requestMode.value)
/* PRQA L:L1 */
...
#  define Rte_Write_Dlog_ProgId_progId(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *********************************************************************************************************************/
#  define Rte_Call_Coding_Svk_GetCafIds(arg1, arg2) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_NvMAdmin_DlogProgData_SetBlockProtection(arg1) (NvM_SetBlockProtection((NvM_BlockIdType)13, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_NVM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define Rte_Call_NvMService_DlogProgData_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)13, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_NVM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define Rte_Call_NvMService_DlogSvkEntry_ReadBlock(arg1) (NvM_ReadBlock((NvM_BlockIdType)27, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_NVM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(Std_ReturnType, RTE_NVM_APPL_CODE) NvM_SetDataIndex(NvM_BlockIdType parg0, uint8 DataIndex); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_NVM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

#  define Rte_Call_NvMService_DlogSvkEntry_SetDataIndex(arg1) (NvM_SetDataIndex((NvM_BlockIdType)27, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_NvMService_DlogSvkEntry_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)27, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_NVM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define Rte_Call_NvMService_DlogSvkHistory_GetErrorStatus(arg1) (NvM_GetErrorStatus((NvM_BlockIdType)10, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_NvMService_DlogSvkHistory_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)10, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
# ifndef RTE_CORE
#  define RTE_RUNNABLE_CondCheckSvkBackup01 Dlog_ConditionCheckSvkBackup01
#  define RTE_RUNNABLE_CondCheckSvkBackup02 Dlog_ConditionCheckSvkBackup02
#  define RTE_RUNNABLE_CondCheckSvkBackup03 Dlog_ConditionCheckSvkBackup03
...
#  define RTE_RUNNABLE_ReadSvkBackup01 Dlog_ReadDataByIdentifierSvkBackup01
#  define RTE_RUNNABLE_ReadSvkBackup02 Dlog_ReadDataByIdentifierSvkBackup02
#  define RTE_RUNNABLE_ReadSvkBackup03 Dlog_ReadDataByIdentifierSvkBackup03
...
# else
FUNC(Std_ReturnType, Dlog_CODE) Dlog_ReadDataByIdentifierSvkBackup01(Dcm_OpStatusType OpStatus, P2VAR(SvkHistoryDataArrayType, AUTOMATIC, RTE_DLOG_APPL_VAR) Data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
# endif
# ifdef RTE_PTR2ARRAYBASETYPE_PASSING
...
# else
FUNC(Std_ReturnType, Dlog_CODE) Dlog_ReadDataByIdentifierSvkBackup02(Dcm_OpStatusType OpStatus, P2VAR(SvkHistoryDataArrayType, AUTOMATIC, RTE_DLOG_APPL_VAR) Data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
# endif
# ifdef RTE_PTR2ARRAYBASETYPE_PASSING
...
# else
FUNC(Std_ReturnType, Dlog_CODE) Dlog_ReadDataByIdentifierSvkBackup03(Dcm_OpStatusType OpStatus, P2VAR(SvkHistoryDataArrayType, AUTOMATIC, RTE_DLOG_APPL_VAR) Data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
# endif
# ifdef RTE_PTR2ARRAYBASETYPE_PASSING
