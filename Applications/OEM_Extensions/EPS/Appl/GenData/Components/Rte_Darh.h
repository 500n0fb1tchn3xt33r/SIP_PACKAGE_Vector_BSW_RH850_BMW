...
extern VAR(Rte_tsDefault_BAC_Appl_BMW_Task, RTE_VAR_NOINIT) Rte_Default_BAC_Appl_BMW_Task; /* PRQA S 0850, 0759 */ /* MD_MSR_19.8, MD_MSR_18.4 */
...
#  define Rte_IRead_LifeCycleHandler_LifeCycleRequest_requestMode() \
  (Rte_Default_BAC_Appl_BMW_Task.Rte_RB.Rte_Darh_LifeCycleHandler.Rte_LifeCycleRequest_requestMode.value)
/* PRQA L:L1 */
...
#  define Rte_Call_DetPort_ReportError(arg1, arg2, arg3) (Det_ReportError((uint16)4098, arg1, arg2, arg3)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_DmTestAppl_SetEventStatus(arg1) (Dem_SetEventStatus((Dem_EventIdType)26, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_DmTestCom_SetEventStatus(arg1) (Dem_SetEventStatus((Dem_EventIdType)27, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_NVM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define Rte_Call_ErrorQueueBlock_SetRamBlockStatus(arg1) (NvM_SetRamBlockStatus((NvM_BlockIdType)25, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_DEMWRAPPER_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
