 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_NvM_NvM_RpNotifyInit_DLOG_SVK_SYS_SUPP_InitBlock(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_NvM_NvM_RpNotifyJobEnd_DLOG_SVK_SYS_SUPP_JobFinished(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
 ...
 *********************************************************************************************************************/
#  define Rte_Call_NvM_RpNotifyInit_DLOG_SVK_SYS_SUPP_InitBlock Rte_Call_NvM_NvM_RpNotifyInit_DLOG_SVK_SYS_SUPP_InitBlock
...
#  define Rte_Call_NvM_RpNotifyJobEnd_DLOG_SVK_SYS_SUPP_JobFinished Rte_Call_NvM_NvM_RpNotifyJobEnd_DLOG_SVK_SYS_SUPP_JobFinished
#  define RTE_START_SEC_DLOG_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define Rte_Call_NvM_RpNotifyJobEnd_NVM_BLOCK_DARH_DiagnoseMasterEnable_JobFinished Darh_NvMNotifyJobFinishedDiagnoseMasterStatus
#  define RTE_START_SEC_DLOG_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define Rte_Call_NvM_RpNotifyJobEnd_NVM_BLOCK_DLOG_SvkEntry_JobFinished Dlog_NotifyJobFinishedSvkEntry
...
#  define Rte_Call_NvM_RpNotifyJobEnd_OmcDependencyNVMData_JobFinished Omc_NvMNotifyJobFinishedOperatingModes
