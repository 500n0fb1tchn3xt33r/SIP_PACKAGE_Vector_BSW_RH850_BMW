...
*
*  GENERATION TIME : 2018-01-22 11:14:55.976707
*
------------------------------------------------------------------------------*/
...
{ \
   DLOG_NVM_BLOCK_SVK_BACKUP_01, \
   DLOG_NVM_BLOCK_SVK_BACKUP_02, \
   DLOG_NVM_BLOCK_SVK_BACKUP_03 \
}
#define DLOG_NUMBEROFSVKBACKUPS         3u
#define DLOG_ECUSERIALNUMBERDEFAULT     '1','2','3','4','5','6','7','8','9','0'

#define DLOG_ECUMANUFACTURINGDATELENGTH      3u
#define DLOG_ECUMANUFACTURINGDATEDEFAULT     0x03,0x11,0x17
...
#define DLOG_SWE_DEV_INFO_LENGTH             16u
...
#define DLOG_NUMBEROFAPPLSWESGBMIDS     1u
...
/* ----------------------------------------------------------------------- */
   ...
   #define DLOG_MEMSEGTABLE_NUM_SEGMENTS   38
