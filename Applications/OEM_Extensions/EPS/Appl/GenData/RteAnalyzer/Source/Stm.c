...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: Runnable_ErrorVehicleState
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered on DataReceiveErrorEvent for DataElementPrototype <VehicleState> of PortPrototype <VehicleStateRx>
 *
 **********************************************************************************************************************
 *
 * Mode Interfaces:
 * ================
 *   Std_ReturnType Rte_Switch_VehicleStateModeSwitchPort_currentVehicleStateMode(Stm_VehicleStateType mode)
 ...
 *   Stm_VehicleStateType Rte_Mode_VehicleStateModeSwitchPort_currentVehicleStateMode(Stm_VehicleStateType *previousMode, Stm_VehicleStateType *nextMode)
 *   Modes of Rte_ModeType_Stm_VehicleStateMode:
 *   - RTE_MODE_Stm_VehicleStateMode_STM_VEHICLE_STATE_CHECK_ANALYS_DIAGNOSTICS
 *   - RTE_MODE_Stm_VehicleStateMode_STM_VEHICLE_STATE_CUSTOMER_ABSENT
 *   - RTE_MODE_Stm_VehicleStateMode_STM_VEHICLE_STATE_DRIVE
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: Runnable_ErrorVehicleState_doc
 *********************************************************************************************************************/
...
FUNC(void, Stm_CODE) Stm_ErrorVehicleState(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: Stm_ErrorVehicleState
 *********************************************************************************************************************/

  Std_ReturnType fct_status;
  boolean fct_error = 0;

  Rte_ModeType_Stm_VehicleStateMode VehicleStateModeSwitchPort_currentVehicleStateMode;
  Rte_ModeType_Stm_VehicleStateMode VehicleStateModeSwitchPort_currentVehicleStateMode_previousMode;
  Rte_ModeType_Stm_VehicleStateMode VehicleStateModeSwitchPort_currentVehicleStateMode_nextMode;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  fct_status = TSC_Stm_Rte_Switch_VehicleStateModeSwitchPort_currentVehicleStateMode(RTE_MODE_Stm_VehicleStateMode_STM_VEHICLE_STATE_UNAVAILABLE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  VehicleStateModeSwitchPort_currentVehicleStateMode = TSC_Stm_Rte_Mode_VehicleStateModeSwitchPort_currentVehicleStateMode(&VehicleStateModeSwitchPort_currentVehicleStateMode_previousMode, &VehicleStateModeSwitchPort_currentVehicleStateMode_nextMode);
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: Runnable_ReceiveVehicleState
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered on DataReceivedEvent for DataElementPrototype <VehicleState> of PortPrototype <VehicleStateRx>
 *
 **********************************************************************************************************************
 *
 * Input Interfaces:
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Read_VehicleStateRx_VehicleState(Stm_VehicleStateType *data)
 *
 * Mode Interfaces:
 * ================
 *   Std_ReturnType Rte_Switch_VehicleStateModeSwitchPort_currentVehicleStateMode(Stm_VehicleStateType mode)
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: Runnable_ReceiveVehicleState_doc
 *********************************************************************************************************************/
...
FUNC(void, Stm_CODE) Stm_ReceiveVehicleState(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: Stm_ReceiveVehicleState
 *********************************************************************************************************************/

  Std_ReturnType fct_status;
  boolean fct_error = 0;

  Stm_VehicleStateType Read_VehicleStateRx_VehicleState;
  ...
  *************************************************/
  ...
  fct_status = TSC_Stm_Rte_Read_VehicleStateRx_VehicleState(&Read_VehicleStateRx_VehicleState);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
