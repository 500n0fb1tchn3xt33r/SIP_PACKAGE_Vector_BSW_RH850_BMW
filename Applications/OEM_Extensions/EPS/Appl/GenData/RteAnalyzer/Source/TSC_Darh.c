...
#include "TSC_Darh.h"
     ...
     /* Service calls */
Std_ReturnType TSC_Darh_Rte_Call_DetPort_ReportError(uint8 InstanceId, uint8 ApiId, uint8 ErrorId)
{
  return Rte_Call_DetPort_ReportError(InstanceId, ApiId, ErrorId);
}
