 ...
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CansmEBusACanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CansmEBusB2CanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CansmEBusBodyCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CansmEBusFaCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CansmEBusIukCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CansmEBusKCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CansmEBusLeCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CansmEBusLpCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CansmEBusZsgCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CantrcvEBusACanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CantrcvEBusB2CanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CantrcvEBusBodyCanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CantrcvEBusFaCanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CantrcvEBusIukError>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CantrcvEBusKCanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CantrcvEBusLeCanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CantrcvEBusLpCanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CantrcvEBusZsgCanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CbsReplacementValue>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CodingEventInvalidData>
 ...
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CodingEventSignatureError>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_CodingEventTransactionFailed>
 ...
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_Dtc000030>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_Dtc000031>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_Dtc000032>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_Dtc000033>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_Dtc000034>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_DtcCd0601>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_DtcCd0605>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_DtcCd0606>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_DtcCd0607>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_EthSignalQualityLow>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_FrifEAcsChA>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_FrifENitChA>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_FrsmEClusterStartup>
 ...
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv0>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv1>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv2>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv3>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv4>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv5>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv6>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv7>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_Overvoltage>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_PiaEIoError>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_SwtExternalCheckFailure>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_SwtInternalCheckFailure>
 *   - triggered by server invocation for OperationPrototype <ResetEventDebounceStatus> of PortPrototype <Event_Undervoltage>
 ...
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CansmEBusACanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CansmEBusB2CanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CansmEBusBodyCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CansmEBusFaCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CansmEBusIukCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CansmEBusKCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CansmEBusLeCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CansmEBusLpCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CansmEBusZsgCanOff>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CantrcvEBusACanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CantrcvEBusB2CanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CantrcvEBusBodyCanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CantrcvEBusFaCanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CantrcvEBusIukError>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CantrcvEBusKCanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CantrcvEBusLeCanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CantrcvEBusLpCanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CantrcvEBusZsgCanError>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CbsReplacementValue>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CodingEventInvalidData>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CodingEventNotCoded>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CodingEventSignatureError>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_CodingEventTransactionFailed>
 ...
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_Dtc000030>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_Dtc000031>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_Dtc000032>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_Dtc000033>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_Dtc000034>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_DtcCd0601>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_DtcCd0605>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_DtcCd0606>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_DtcCd0607>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_EthSignalQualityLow>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_FrifEAcsChA>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_FrifENitChA>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_FrsmEClusterStartup>
 ...
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv0>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv1>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv2>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv3>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv4>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv5>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv6>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv7>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_Overvoltage>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_PiaEIoError>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_SwtExternalCheckFailure>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_SwtInternalCheckFailure>
 *   - triggered by server invocation for OperationPrototype <ResetEventStatus> of PortPrototype <Event_Undervoltage>
 ...
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CansmEBusACanOff>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CansmEBusB2CanOff>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CansmEBusBodyCanOff>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CansmEBusFaCanOff>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CansmEBusIukCanOff>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CansmEBusKCanOff>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CansmEBusLeCanOff>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CansmEBusLpCanOff>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CansmEBusZsgCanOff>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CantrcvEBusACanError>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CantrcvEBusB2CanError>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CantrcvEBusBodyCanError>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CantrcvEBusFaCanError>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CantrcvEBusIukError>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CantrcvEBusKCanError>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CantrcvEBusLeCanError>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CantrcvEBusLpCanError>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CantrcvEBusZsgCanError>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CbsReplacementValue>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CodingEventInvalidData>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CodingEventNotCoded>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CodingEventSignatureError>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_CodingEventTransactionFailed>
 ...
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_Dtc000030>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_Dtc000031>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_Dtc000032>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_Dtc000033>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_Dtc000034>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_DtcCd0601>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_DtcCd0605>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_DtcCd0606>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_DtcCd0607>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_EthSignalQualityLow>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_FrifEAcsChA>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_FrifENitChA>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_FrsmEClusterStartup>
 ...
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv0>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv1>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv2>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv3>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv4>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv5>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv6>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_FrtrcvEFrErrnTrcv7>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_Overvoltage>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_PiaEIoError>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_SwtExternalCheckFailure>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_SwtInternalCheckFailure>
 *   - triggered by server invocation for OperationPrototype <SetEventStatus> of PortPrototype <Event_Undervoltage>
