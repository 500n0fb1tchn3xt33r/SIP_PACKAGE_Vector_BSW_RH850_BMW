 ...
 *   EcuMConf_EcuMResetMode_ECUM_RESET_PROGRAMMING (4U)
 *   EcuMConf_EcuMResetMode_ECUM_RESET_APPLICATIONRESTART (5U)
 ...
 *   EcuMConf_EcuMShutdownCause_ECUM_CAUSE_CODING (4U)
...
static void EcuM_TestDefines(void)
{
  ...
  EcuM_ModeType Test_EcuM_ModeType_V_5 = EcuMConf_EcuMResetMode_ECUM_RESET_PROGRAMMING;
  EcuM_ModeType Test_EcuM_ModeType_V_6 = EcuMConf_EcuMResetMode_ECUM_RESET_APPLICATIONRESTART;
  ...
  EcuM_ShutdownCauseType Test_EcuM_ShutdownCauseType_V_5 = EcuMConf_EcuMShutdownCause_ECUM_CAUSE_CODING;
