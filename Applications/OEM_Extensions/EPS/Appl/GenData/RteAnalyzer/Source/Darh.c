 ...
 *********************************************************************************************************************/
  ...
  *************************************************/
  ...
  fct_status = TSC_Darh_Rte_Call_DetPort_ReportError(0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  *************************************************/
  ...
  switch (fct_status)
  {
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_DataServices_ActivelyReportedDtc_E_NOT_OK:
      fct_error = 1;
      break;
  }
  ...
  *************************************************/
  ...
  switch (fct_status)
  {
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_DarhControlInterface_E_NOT_OK:
      fct_error = 1;
      break;
  }
  ...
  *************************************************/
  ...
  switch (fct_status)
  {
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_RoutineServices_TriggerDTC_DCM_E_FORCE_RCRRP:
      fct_error = 1;
      break;
    case RTE_E_RoutineServices_TriggerDTC_DCM_E_PENDING:
      fct_error = 1;
      break;
    case RTE_E_RoutineServices_TriggerDTC_E_NOT_OK:
      fct_error = 1;
      break;
  }
