...
extern CONST(Os_TimerIsrConfigType, OS_CONST) OsCfg_Isr_CounterIsr_TpCounter_OsCore_CORE0;
...
extern CONST(Os_TimerIsrConfigType, OS_CONST) OsCfg_Isr_Os_TimerPitIsr;
