...
/* -----------------------------------------------------------------------------
    &&&~ RULE DEFINES
 ----------------------------------------------------------------------------- */
#define BswMConf_BswMRule_Rule_DcmCodingReset (20) 
#define BswMConf_BswMRule_Rule_Dlog_Init_when_IS_Startup (22) 
#define BswMConf_BswMRule_Rule_Dlog_Run_when_Dlog_Init (23) 
#define BswMConf_BswMRule_Rule_Start_Omc_Init_when_Darh_Run (33) 
#define BswMConf_BswMRule_Rule_Start_StdDiag_Init_when_Omc_Run (35) 
#define BswMConf_BswMRule_Rule_Start_Darh_Run_when_Darh_Init (32) 
#define BswMConf_BswMRule_Rule_Start_Omc_Run_when_Omc_Init (34) 
#define BswMConf_BswMRule_Rule_Start_StdDiag_Run_when_StdDiag_Init (36) 
#define BswMConf_BswMRule_Rule_Start_Systime_Run_when_Systime_Init (37) 
#define BswMConf_BswMRule_Rule_DcmEcuReset (21) 
#define BswMConf_BswMRule_Rule_Systime_Init (39) 
#define BswMConf_BswMRule_Rule_Darh_Init (19) 
#define BswMConf_BswMRule_Rule_ComM_Channel_is_FULL_COM (16) 
#define BswMConf_BswMRule_Rule_ComM_Channel_is_SILENT_COMMUNICATION (18) 
#define BswMConf_BswMRule_Rule_Set_DarhReportError_due_ComM_and_CEL_mode (29) 
#define BswMConf_BswMRule_Rule_Switch_StdDiagSessionChangeIndication (38) 
#define BswMConf_BswMRule_Rule_NDC_Enable_Rx_Enable_Tx (27) 
#define BswMConf_BswMRule_Rule_NDC_Enable_Rx_Disable_Tx (26) 
#define BswMConf_BswMRule_Rule_NDC_Disable_Rx_Enable_Tx (25) 
#define BswMConf_BswMRule_Rule_NDC_Disable_Rx_Disable_Tx (24) 
#define BswMConf_BswMRule_Rule_Shutdown (31) 
#define BswMConf_BswMRule_Rule_ComM_Channel_is_NO_COM (17) 
#define BswMConf_BswMRule_Rule_Set_EcuRunMode_to_Normal_Operation_when_all_modules_run (30) 
#define BswMConf_BswMRule_Rule_Reset_when_SimpleTimer0_fired (28) 
#define BswMConf_BswMRule_Rule_BS_Init (14) 
#define BswMConf_BswMRule_Rule_Bs_Run (15) 
...
#define BswMConf_BswMRule_ESH_DemInit (2) 
...
#define BswMConf_BswMRule_CC_A_FlexRay_5b5a9ac2_TX (1) 
#define BswMConf_BswMRule_CC_A_FlexRay_5b5a9ac2_RX (0) 


/* -----------------------------------------------------------------------------
    &&&~ GENERIC DEFINES
 ----------------------------------------------------------------------------- */
#define BSWM_GENERIC_GenericModeRequestPort_IS_CodingReset 0U 
...
#define BSWM_GENERICVALUE_GenericModeRequestPort_IS_CodingReset_IS_CodingReset_EXECUTE 0x0001U 
#define BSWM_GENERICVALUE_GenericModeRequestPort_IS_CodingReset_IS_CodingReset_NONE    0x0000U 
...
#define BSWM_EQ2_EXTERNALIDOFCOMMCHANNELMAPPING                       ComMConf_ComMChannel_A_FlexRay_5b5a9ac2
#define BSWM_EQ2_IMMEDIATEUSERENDIDXOFCOMMCHANNELMAPPING              1U
#define BSWM_EQ2_IMMEDIATEUSERSTARTIDXOFCOMMCHANNELMAPPING            0U
...
#define BSWM_EQ2_EXTERNALIDOFFRSMMAPPING                              ComMConf_ComMChannel_A_FlexRay_5b5a9ac2
#define BSWM_EQ2_IMMEDIATEUSERENDIDXOFFRSMMAPPING                     2U
#define BSWM_EQ2_IMMEDIATEUSERSTARTIDXOFFRSMMAPPING                   1U
...
{
  BswM_ActionListQueueType AL_AL_CodingResetExecution[1];
  BswM_ActionListQueueType AL_AL_Rule_Dlog_Init_True[1];
  BswM_ActionListQueueType AL_AL_Rule_Dlog_Run_True[1];
  BswM_ActionListQueueType AL_AL_Rule_Start_Omc_Init_when_Darh_Run_True[1];
  BswM_ActionListQueueType AL_AL_Rule_Start_StdDiag_Init_when_Omc_Run_True[1];
  BswM_ActionListQueueType AL_AL_RuleDarh_Init_to_Run_True[1];
  BswM_ActionListQueueType AL_AL_Rule_Start_Omc_Run_when_Omc_Init_True[1];
  BswM_ActionListQueueType AL_AL_Rule_Start_StdDiag_Run_when_StdDiag_Init_True[1];
  BswM_ActionListQueueType AL_AL_Rule_Start_Systime_Run_when_Systime_Init_True[1];
  BswM_ActionListQueueType AL_AL_ResetExecution[1];
  BswM_ActionListQueueType AL_AL_Rule_Systime_Init_True[1];
  BswM_ActionListQueueType AL_AL_Rule_Darh_Init_True[1];
  BswM_ActionListQueueType AL_AL_ComM_Channel_is_FULL_COM[1];
  BswM_ActionListQueueType AL_AL_ComM_Channel_is_SILENT_COMMUNICATION_BswMActionList_True[1];
  ...
  BswM_ActionListQueueType AL_AL_Switch_StdDiagSessionChangeIndication_True[1];
  BswM_ActionListQueueType AL_AL_Switch_StdDiagSessionChangeIndication_False[1];
  ...
  BswM_ActionListQueueType AL_AL_ComM_Channel_is_NO_COM_BswMActionList_True[1];
  BswM_ActionListQueueType AL_AL_Set_EcuRunMode_to_Normal_Operation_when_all_modules_run_BswMActionList_True[1];
  BswM_ActionListQueueType AL_AL_Reset_when_SimpleTimer0_fired_BswMActionList_True[1];
  BswM_ActionListQueueType AL_AL_Bs_Run_when_Bs_Init[1];
  BswM_ActionListQueueType AL_AL_BswMActionList_Bs_Init_True[1];
  ...
  BswM_ActionListQueueType AL_CC_AL_A_FlexRay_5b5a9ac2_TX_Disable[1];
  BswM_ActionListQueueType AL_CC_AL_A_FlexRay_5b5a9ac2_TX_EnableNoinit[1];
  BswM_ActionListQueueType AL_CC_AL_A_FlexRay_5b5a9ac2_RX_Disable[1];
  BswM_ActionListQueueType AL_CC_AL_A_FlexRay_5b5a9ac2_RX_EnableNoinit[1];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  BswM_ActionListQueueType raw[45];
