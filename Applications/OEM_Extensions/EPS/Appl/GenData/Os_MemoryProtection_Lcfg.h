...
extern CONST(Os_MpAccessRightsType, OS_CONST) OsCfg_Mp_OsApplication_ASIL;
...
extern CONST(Os_MpAccessRightsType, OS_CONST) OsCfg_Mp_CounterIsr_TpCounter_OsCore_CORE0;
...
extern CONST(Os_MpAccessRightsType, OS_CONST) OsCfg_Mp_Os_TimerPitIsr;
extern CONST(Os_MpAccessRightsType, OS_CONST) OsCfg_Mp_WDG_59_DRIVERA_TRIGGERFUNCTION_CAT2_ISR;
...
extern CONST(Os_MpAccessRightsType, OS_CONST) OsCfg_Mp_Default_BAC_Appl_BMW_Task;
extern CONST(Os_MpAccessRightsType, OS_CONST) OsCfg_Mp_Default_BSW_Sync_Task;
extern CONST(Os_MpAccessRightsType, OS_CONST) OsCfg_Mp_Default_Background_Task;
...
extern CONST(Os_MpAccessRightsType, OS_CONST) OsCfg_Mp_OsTask_BSW_ASIL;
extern CONST(Os_MpAccessRightsType, OS_CONST) OsCfg_Mp_OsTask_LowPrioNvm;
