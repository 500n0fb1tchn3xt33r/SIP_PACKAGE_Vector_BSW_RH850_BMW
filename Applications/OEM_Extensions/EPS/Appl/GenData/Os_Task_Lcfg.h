...
extern CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_Default_BAC_Appl_BMW_Task;
...
extern CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_OsTask_BSW_ASIL;

/*! Task configuration data: OsTask_LowPrioNvm */
extern CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_OsTask_LowPrioNvm;
