...
#define DEM_CFG_DATA_OVFLIND                                               STD_ON       /* Autodetected - STD_ON: any /Dem/DemGeneral/DemDataClass/DemDataElementInternalData == DEM_OVFLIND exists, STD_OFF: else */ 
