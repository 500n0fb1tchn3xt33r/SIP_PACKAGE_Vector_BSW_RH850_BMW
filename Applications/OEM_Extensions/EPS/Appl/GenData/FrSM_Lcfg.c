...
CONST(FrSM_ClusterConfigType, FRSM_CONST) FrSM_ClusterConfig[1] = {
    /* Index    DurationT4  ColdstartEcu  WakeupEcu  ControllerIndex  DurationT1  DurationT2  DurationT3  FrIfClusterIndex  NetworkHandle  NumWakeupPatterns  StartupRepetitions  StartupRepetitionsWithWakeup  TrcvStbyDelay  FrChannel    */
  { /*     0 */         0U,         TRUE,      TRUE,              0U,         1U,        10U,       100U,               0U,           0UL,                1U,                 0U,                           0U,            0U, FR_CHANNEL_A }
};
