...
/*
 * INPUT FILE:    D:\TEMP\DaVinci\Cfg-9461008\Generation\Cfg_Gen-1512464595813-0\AutosarFiles_ValGen-1512482165317-0\ExtGen_DrvFls_ECUC_4380222254767406062.arxml
 *                D:\usr\usage\Delivery\CBD17x\CBD1700369\D04\external\ThirdParty\Mcal_Rh850P1x\Supply\AUTOSAR_RH850_P1x_MCAL_Ver4.02.01.D\X1X\P1x\modules\fls\generator\R403_fls_P1x_BSWMDT.arxml
 * GENERATED ON:   5 Dec 2017 - 14:56:20
 */
#ifndef FLS_CFG_H
#define FLS_CFG_H
...
#define FLS_E_COMPARE_FAILED              \
  DemConf_DemEventParameter_DemEventParameter_FlsConfigSet_FLS_E_COMPARE_FAILED

/* Report error to DEM that erase job failed */
#define FLS_E_ERASE_FAILED                \
  DemConf_DemEventParameter_DemEventParameter_FlsConfigSet_FLS_E_ERASE_FAILED

/* Report error to DEM that read job failed */
#define FLS_E_READ_FAILED                 \
  DemConf_DemEventParameter_DemEventParameter_FlsConfigSet_FLS_E_READ_FAILED

/* Report error to DEM that write job failed */
#define FLS_E_WRITE_FAILED                \
  DemConf_DemEventParameter_DemEventParameter_FlsConfigSet_FLS_E_WRITE_FAILED

/* Report error to DEM that read job failed due to double bit ECC error */
#define FLS_E_READ_FAILED_DED             \
  DemConf_DemEventParameter_DemEventParameter_FlsConfigSet_FLS_E_READ_DED_FAILED
...
#define FLS_E_HW_FAILURE                  \
  DemConf_DemEventParameter_DemEventParameter_FlsConfigSet_FLS_E_HW_FAILED
...
#define FLS_FACIFRTEINT            (*((volatile uint8 *)(0xFFA1009CUL)))
...
#define FLS_E_ECC_FAILED                    \
  DemConf_DemEventParameter_DemEventParameter_FlsConfigSet_FLS_E_ECC_FAILED
