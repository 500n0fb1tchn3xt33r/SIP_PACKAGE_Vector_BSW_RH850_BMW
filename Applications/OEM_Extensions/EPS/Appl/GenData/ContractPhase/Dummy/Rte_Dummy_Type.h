 ...
 *
 *   Description:  Application types header file for SW-C <Dummy> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DUMMY_TYPE_H
# define _RTE_DUMMY_TYPE_H
