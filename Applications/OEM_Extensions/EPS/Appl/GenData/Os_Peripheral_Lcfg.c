...
/*! Peripheral configuration data: OsPeripheralRegion_FR */
OS_LOCAL CONST(Os_PeripheralConfigType, OS_CONST) OsCfg_Peripheral_OsPeripheralRegion_FR =
{
  /* .AddressStart          = */ (Os_AddressOfConstType) 0xFFC72000UL,
  /* .AddressEnd            = */ (Os_AddressOfConstType) 0xFFC72FFFUL,
...
{
  &OsCfg_Peripheral_OsPeripheralRegion_FR,
  NULL_PTR
};
