...
*
*  GENERATION TIME : 2018-01-22 11:14:56.523762
*
------------------------------------------------------------------------------*/
...
static UDS_ReturnType Dlog_UDSReadDataSvkBackup01(uint8* responseData, size_t* dataLength, UDS_ErrorCodeType* errorCode) {
  return Dlog_ReadDataSvkHistory(2, responseData, dataLength, errorCode);
}

Std_ReturnType Dlog_ConditionCheckSvkBackup01
                      (
                         Dcm_OpStatusType OpStatus,
                         Dcm_NegativeResponseCodeType* ErrorCode
                      )
{
  return BUtil_UDS_ConditionCheckRead(&Dlog_UDSAdapterContext, &Dlog_UDSReadDataSvkBackup01, OpStatus, ErrorCode);
}

Std_ReturnType Dlog_ReadDataByIdentifierSvkBackup01
                      (
                         Dcm_OpStatusType OpStatus,
                         uint8* Data
                      )
...
static UDS_ReturnType Dlog_UDSReadDataSvkBackup02(uint8* responseData, size_t* dataLength, UDS_ErrorCodeType* errorCode) {
  return Dlog_ReadDataSvkHistory(3, responseData, dataLength, errorCode);
}

Std_ReturnType Dlog_ConditionCheckSvkBackup02
                      (
                         Dcm_OpStatusType OpStatus,
                         Dcm_NegativeResponseCodeType* ErrorCode
                      )
{
  return BUtil_UDS_ConditionCheckRead(&Dlog_UDSAdapterContext, &Dlog_UDSReadDataSvkBackup02, OpStatus, ErrorCode);
}

Std_ReturnType Dlog_ReadDataByIdentifierSvkBackup02
                      (
                         Dcm_OpStatusType OpStatus,
                         uint8* Data
                      )
...
static UDS_ReturnType Dlog_UDSReadDataSvkBackup03(uint8* responseData, size_t* dataLength, UDS_ErrorCodeType* errorCode) {
  return Dlog_ReadDataSvkHistory(4, responseData, dataLength, errorCode);
}

Std_ReturnType Dlog_ConditionCheckSvkBackup03
                      (
                         Dcm_OpStatusType OpStatus,
                         Dcm_NegativeResponseCodeType* ErrorCode
                      )
{
  return BUtil_UDS_ConditionCheckRead(&Dlog_UDSAdapterContext, &Dlog_UDSReadDataSvkBackup03, OpStatus, ErrorCode);
}

Std_ReturnType Dlog_ReadDataByIdentifierSvkBackup03
                      (
                         Dcm_OpStatusType OpStatus,
                         uint8* Data
                      )
