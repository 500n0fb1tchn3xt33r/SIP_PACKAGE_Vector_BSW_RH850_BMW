...
# 2007/08/02   1.01     Get  Added support of AUTOSAR FLASH                   #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
FLASH_CORE_PATH    =
FLASH_OUTPUT_PATH  = $(GENDATA_DIR)

#FLASH_TOOL_PATH   = $(PROJECT_ROOT)\core\com\can\gentool
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     += Flash Flash\build
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
