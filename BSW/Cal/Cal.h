 ...
 *  02.01.02  2016-10-10  Mss     ESCAN00091619: Fixed potential misaligned access through context buffer
 *                        Tof     ESCAN00091573: Fixed compiler error when CAL_DISABLE_NOT_USED_APIS = STD_OFF
 *********************************************************************************************************************/
...
# define SYSSERVICE_ASRCAL_RELEASE_VERSION  (0x02u)
