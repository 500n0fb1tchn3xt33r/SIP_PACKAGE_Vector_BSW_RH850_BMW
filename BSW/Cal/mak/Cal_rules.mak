...
# 2014-10-01   2.01.00  vismss Services added                                 #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 1.0                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += Cal
Cal_FILES                = Cal\Cal.c \
                           Cal\Cal_Hash.c \
                           Cal\Cal_KeyDerive.c \
                           Cal\Cal_KeyExchange.c \
                           Cal\Cal_MacGenerate.c \
                           Cal\Cal_MacVerify.c \
                           Cal\Cal_Random.c \
                           Cal\Cal_SignatureVerify.c \
                           Cal\Cal_SymBlockDecrypt.c \
                           Cal\Cal_SymBlockEncrypt.c \
                           Cal\Cal_SymDecrypt.c \
                           Cal\Cal_SymEncrypt.c \
                           Cal\Cal_SymKeyExtract.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Cal\Cal.c \
                           Cal\Cal_Hash.c \
                           Cal\Cal_KeyDerive.c \
                           Cal\Cal_KeyExchange.c \
                           Cal\Cal_MacGenerate.c \
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Cal_Cfg.c
