...
/*------------------------------------------------------------------------------
                      Global Variables
-------------------------------------------------------------------------------*/
/*@@@patchedByVector_START: workaround for BAC-6612*/
...
#define Dlog_START_SEC_VAR_SHARED_SWEINFOS
#include "Dlog_MemMap.h"  /* PRQA S 5087 */

Dlog_SweInfoType Dlog_SweInfos[DLOG_MAX_NUMBER_OF_SWES];

#define Dlog_STOP_SEC_VAR_SHARED_SWEINFOS
#include "Dlog_MemMap.h"  /* PRQA S 5087 */

#define Dlog_START_SEC_VAR_SHARED_DATA
#include "Dlog_MemMap.h"  /* PRQA S 5087 */

Dlog_DataType Dlog_Data;

#define Dlog_STOP_SEC_VAR_SHARED_DATA
#include "Dlog_MemMap.h"  /* PRQA S 5087 */
/*@@@patchedByVector_END: workaround for BAC-6612*/
